  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        descubrí el mundo de la tecnología y el desarrollo web. Mi stack
        principal es{" "}
        <span className="font-medium">
          React, Next.js, TypeScript, Node, Express y MongoDB
        </span>
        ...
        formado en buenas prácticas de programación y clean code aprendiendo{" "}
        <span className="font-medium">
